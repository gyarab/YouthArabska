            ...
            <div className="glass-card p-6 sm:p-8 md:p-12 bg-gradient-to-br from-accent/8 to-dawn-orange/8 border-accent/25">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <a
                  ...
                  className="btn-glow-gold inline-flex items-center gap-2 px-5 sm:px-6 py-3 rounded-xl bg-gradient-to-r from-dawn-gold to-dawn-orange text-black font-semibold hover:scale-[1.02] transition-transform duration-200 whitespace-nowrap text-sm sm:text-base w-full md:w-auto justify-center"
                >
